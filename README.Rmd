...
{AAGIThemes} provides RMarkdown Word document templates for you to quickly and easily create RMarkdown documents that use the AAGI colours in the template.
