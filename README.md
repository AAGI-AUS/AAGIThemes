...
quickly and easily create RMarkdown documents that use the AAGI blue,
green and red colourways as the template. The templates are available
through RStudio, `File > New File > R Markdown`, then select “From
Template” and then select the template colourway you’d like to use. The
template’s colourway will sync with the {ggplot2} facet background
