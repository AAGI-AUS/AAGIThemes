---
title: "DPIRD Green Colourway Word Template for RMarkdown"
subtitle: "Live the RStudio Lifestyle You've Always Dreamed of in DPIRD Green"
output: 
  word_document:
     fig_caption: yes
     number_sections: FALSE
     reference_docx: "DPIRD_Green_Report_Template.docx"
     pandoc_args:
...
library(ggplot2)
library(theme.aagi)
theme_set(theme_aagi(colourway = "dpird red"))
```
