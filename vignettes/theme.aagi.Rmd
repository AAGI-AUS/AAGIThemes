...
For more info on {theme.aagi} check out the [package's GitHub repository](https://github.com/AAGI-Org-AU-Public/theme.aagi), but most of the details about how to use the package and its functions are detailed below. 
